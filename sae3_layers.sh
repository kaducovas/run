createTuningJobFiles.py all \
              ...
              -pp_nEt 4 \
              -pp_nEta 9 \
              -ppCol "[Norm1(),StackedAutoEncoder({'hidden_neurons' : [$1], 'aetype' : 'vanilla'}),StackedAutoEncoder({'hidden_neurons' : [$2], 'aetype' : 'vanilla'}),StackedAutoEncoder({'hidden_neurons' : [$3], 'aetype' : 'vanilla'}),SAE_FineTuning()]"
              #PCA({'energy' : 66})]"
